...
public class DepartController {
     ...
     */
    @SentinelResource(value = "qpsFlowRule", blockHandler = "findByIdBlockHandler",
     ...
     * 定义限流阻断处理方法
     */
    public Depart findByIdBlockHandler(int id, BlockException e) {
        return new Depart()
                .setId(id)
                .setName("qps-flow-block-" + id + "-" + e);
    }
...
//            return Collections.singletonList(new Depart().setName("qps-flow-block"));
//        } finally {
//            if (entry != null) {
//                entry.exit();
//            }
...
//    }
    ...
    @SentinelResource(value = "qpsFlowRuleList")
    @GetMapping("/list")
    public List<Depart> list() {
        return restTemplate.getForObject(SERVICE_PROVIDER + "/list", List.class);
    }
