...
import com.yw.sca.fallback.DepartServiceFallback;
 ...
 * @author yangwei
 */
@FeignClient(value = "msc-provider-depart", fallback = DepartServiceFallback.class) //该参数指定的是提供者的微服务名称，这个名称也称为Feign客户端名称
